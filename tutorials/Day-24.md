...
- 📝 论文 [Agent Injection Attack](https://arxiv.org/abs/2402.08584)
- 📄 文章 [多 Agent 安全攻防](https://www.anthropic.com/engineering/)
- 🛠 工具 [Agent 安全评估框架](https://github.com/)
...
构建一个 Agent 安全靶场，复现工具劫持、记忆投毒、横向移动，并实现防御

**第二部分：** 安装并使用 Garak 和 PyRIT 对 LLM 服务做自动化安全评估，生成评估报告
